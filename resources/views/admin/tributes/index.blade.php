        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8">
                    <h3 class="text-2xl font-bold mb-4">All Pending Tributes</h3>
                    @if (session('success'))
                    ...
                    <div class="space-y-6">
                                ...
                                <div class="flex justify-between items-start">
                                    <div>
                                        <p class="text-sm text-gray-500">
                                            ...
                                            (Owned by: <a href="{{ route('admin.users.edit', $tribute->memorial->user) }}" class="text-blue-600 hover:underline">{{ $tribute->memorial->user->name }}</a>)
                                        </p>
                                        <p class="mt-2">
                        ...
                        @empty
                            <div class="border-dashed border-2 border-gray-300 rounded-lg p-8 text-center">
                                <p class="text-gray-500">There are no pending tributes to review across the site.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
